...
public final class CameraXLivePreviewActivity extends AppCompatActivity
    ...
    private String selectedModel = AUTOML_LABELING;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            selectedModel = savedInstanceState.getString(STATE_SELECTED_MODEL, AUTOML_LABELING);
        ...
        try {
            switch (selectedModel) {
                case AUTOML_LABELING:
                    imageProcessor = new AutoMLImageLabelerProcessor(this, Mode.LIVE_PREVIEW);
                    break;
                default:
