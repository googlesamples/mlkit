...
This ML Kit Vision Quickstart sample app demonstrates how to use and integrate various vision based ML Kit features into your app.
...
* Run the sample code on your iOS device or emulator
